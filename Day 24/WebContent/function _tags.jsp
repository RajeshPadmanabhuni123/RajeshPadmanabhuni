...
<body>
<c:set var="String" value="Rajesh Rockzz"/>  
  
<c:if test="${fn:contains(String, 'Rajesh')}">  
   <p>Found hello <p>  
</c:if>
<c:set var="String" value="Haii, How are you"/>  

<c:if test="${fn:containsIgnoreCase(String, 'how')}">  
   <p>Found how <p>  
</c:if>
<c:set var="String" value="rowdy"/>  

<c:if test="${fn:endsWith(String, 'y')}">  
   <p>Found y at ending <p>  
</c:if>
<c:if test="${fn:startsWith(String, 'r')}">  
   <p>Found r at beginning <p>  
</c:if>
...
<c:set var="str1" value="Welcome-to-the-data-world."/>  
